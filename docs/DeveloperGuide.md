...
>Note how the `Model` simply raises a `WhatNowChangedEvent` when the Address Book data are changed,
...
`*` | user with many tasks in WhatNow | sort tasks by name | locate a task easily

{More to be added}

## Appendix B : Use Cases

(For all use cases below, the **System** is the `WhatNow` and the **Actor** is the `user`, unless specified otherwise)
...
2. WhatNow shows a list of tasks
3. User requests to delete a specific task in the list
4. WhatNow deletes the task <br>
Use case ends.
...
> 3a1. WhatNow shows an error message <br>
